...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded mt-3">
        ...
        <a class="collapse-item" href="utilities-other.html">Additional (Product)</a>
        <a class="collapse-item" href="utilities-other.html">Hold Remarks</a>
        <a class="collapse-item" href="utilities-other.html">Customer</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed pb-0" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
      ...
      <span>Outlet Setting</span>
    </a>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded mt-3">
        <!-- <h6 class="collapse-header">Custom Components:</h6> -->
        <a class="collapse-item" href="buttons.html">Outlet User</a>
        <a class="collapse-item" href="cards.html">Outlet Parameters</a>
      </div>
    </div>
  </li>
  ...
  <!-- Divider -->
  <hr class="sidebar-divider d-none d-md-block my-0 mt-3">
